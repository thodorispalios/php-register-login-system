    ...
    <body>
        ...
        <main role="main" class="container-fluid">
            <div class="row justify-content-md-center header">
                <div class="col-md-auto header-message">
                    <h1>Καλως ήλθατε στο Webite</h1>
                    <h5>Σε αυτή τη σελίδα θα βρείτε εκπαιδευτικά παιχνίδια με διάφορα επίπεδα δυσκολίας</h5>
                    <div class="spacer"></div>
                    <a class="btn btn-primary btn-lg" href="gamesindex.php" role="button">Δοκιμάστε τα</a>
                </div>
            </div>
        </main><!-- /.container -->
    </body>
